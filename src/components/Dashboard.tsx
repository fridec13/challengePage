            ...
            {isLoading ? (
              ...
              <div className="space-y-4">
                <div 
                  ...
                  className="bg-gradient-to-r from-indigo-50 to-purple-50 p-4 rounded-lg border border-indigo-200 cursor-pointer hover:shadow-md transition-shadow group"
                >
            ...
            <div className="space-y-4">
              {completedChallenges.slice(0, 3).map((item) => {
                ...
                <div 
                  ...
                  className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-lg border border-blue-200 cursor-pointer hover:shadow-md transition-shadow group"
                >
                  <div className="flex items-center justify-between">
